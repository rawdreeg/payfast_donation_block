...
/**
 * Provides a list controller for the payfast donations entity type.
 */
class PayfastDonationsListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new PayfastDonationsListBuilder object.
   *
  ...
  public function buildHeader() {
    ...
    $header['donation_amount'] = $this->t('Donation amount');
